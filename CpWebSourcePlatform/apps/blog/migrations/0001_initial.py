    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('acticle_sn', models.CharField(default='', help_text='文章唯一标识', max_length=50, verbose_name='文章唯一标识')),
                ('acticle_name', models.CharField(help_text='文章标题', max_length=100, verbose_name='文章标题')),
                ('acticle_content', DjangoUeditor.models.UEditorField(default='', help_text='内容', verbose_name='内容')),
                ('comment_num', models.IntegerField(default=0, help_text='评价数', verbose_name='评价数')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('image', models.ImageField(help_text='轮播图片', upload_to='blog/images/', verbose_name='轮播图片')),
                ('index', models.IntegerField(default=0, help_text='轮播顺序', verbose_name='轮播顺序')),
                ('add_time', models.DateTimeField(default=datetime.datetime.now, verbose_name='添加时间')),
                ('article', models.ForeignKey(help_text='博客文章', on_delete=django.db.models.deletion.CASCADE, to='blog.BlogActicle', verbose_name='博客文章')),
            ],
            options={
                'verbose_name': '轮播文章',
